  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <AnalyticsRangeSelector value={selectedRange} onChange={onChangeRange} />
      </div>
        ...
        {analyticsLoading ? (
          ...
          <>
            <div className="bg-blue-600 dark:bg-blue-700 rounded-xl p-6 border border-blue-500 dark:border-blue-600">
              ...
              <p className="text-xs text-blue-100/80 mt-2">vs last month</p>
            </div>
            ...
            <div className="bg-emerald-600 dark:bg-emerald-700 rounded-xl p-6 border border-emerald-500 dark:border-emerald-600">
              ...
              <p className="text-xs text-emerald-100/80 mt-2">vs last month</p>
            </div>
            ...
            <div className="bg-fuchsia-600 dark:bg-fuchsia-700 rounded-xl p-6 border border-fuchsia-500 dark:border-fuchsia-600">
              ...
              <p className="text-fuchsia-100 text-sm">Avg Response Time</p>
              <p className="text-3xl font-bold text-white mt-1">
                {formatAverageResponseTime(analytics.average_response_time)}
              </p>
              <p className="text-xs text-fuchsia-100/80 mt-2">vs last month</p>
            </div>
            ...
            <div className="bg-orange-600 dark:bg-orange-700 rounded-xl p-6 border border-orange-500 dark:border-orange-600">
              ...
              <p className="text-xs text-orange-100/80 mt-2">vs last month</p>
            </div>
          </>
        )}
      </div>
